...
@php
    ...
    $strings = [
        'welcome_title'   => $t('login_area.title', $isAr ? 'مرحباً بك!' : 'Welcome back!'),
        'welcome_sub'     => $t('login_area.subtitle', $isAr ? 'سجل دخولك للوصول إلى لوحة التحكم الخاصة بك' : 'Sign in to access your dashboard'),
...
@endphp
    ...
    <div class="login-container">
        ...
        <div class="form-side">
            ...
            <form action="{{ areaManager_url('login') }}" method="post" id="loginForm">
