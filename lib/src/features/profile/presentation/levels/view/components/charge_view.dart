...
class ChargeView extends StatelessWidget {
  ...
  const ChargeView({super.key, required this.data});
        ...
        children: [
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                TextWidget(
                  StringManager.chargeDescription.tr(),
                ...
                10.hBox,
                TextWidget(
                  StringManager.chargeDescriptionBody.tr(),
                  // Fixed-dark level page: use the fixed light-grey, not the
                  // theme-branching secondaryText (dark-ish on light themes).
                  style: context.bodyMedium
                      .size(15)
