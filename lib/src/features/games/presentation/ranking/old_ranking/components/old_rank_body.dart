...
class OldRankBody extends StatefulWidget {
  ...
  @override
  State<OldRankBody> createState() => _OldRankBodyState();
}

class _OldRankBodyState extends State<OldRankBody>
                  ...
                  child: RefreshIndicatorWidget(
                    ...
                    child: CustomScrollView(
                      ...
                      slivers: [
                        ...
                        SliverToBoxAdapter(
                          child: Padding(
                            padding: context.paddingOnly(top: 0),
                            child: OldRankContainerWidget(
