...
class NumberPicker extends StatelessWidget {
  ...
  Widget _integerListView(ThemeData themeData) {
    ...
    selectedStyle = selectedRowStyle ?? themeData.textTheme.displayMedium!;
...
class NumberPickerDialog extends StatefulWidget {
  ...
  const NumberPickerDialog.integer({
    ...
    this.isShowMonthName = false,
    this.isJalali = false,
  })  : confirmWidget = confirmWidget ?? const TextWidget("OK"),
        cancelWidget = cancelWidget ?? const TextWidget("CANCEL"),
        decimalPlaces = 0,
