...
class AreaManagerChargeReportController extends MainController
{
    ...
    {
        $areaManager = AreaManager::find(request('id'));

        return view('admin.grid.common.report.areaManagerCharges', compact('areaManager'))->render();
    }
