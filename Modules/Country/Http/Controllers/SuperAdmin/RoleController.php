...
class RoleController extends MainController
{
    ...
    public function form($id = null)
    {
        ...
        $permissions = Permission::with('permissionTypes')
            ->whereHas('permissionTypes', fn($q) => $q->where('type', 'country'))
            ->get();
        $roleModel = config('admin.database.roles_model');
        ...
        $form->saving(function (Form $form) {
            ...
            $form->model()->admin_id = auth()->user()->type == 'country' ? auth()->user()->id : auth()->user()->parent_id;
        ...
        $form->saved(function (Form $form) {
            ...
            $form->admin_id = auth()->user()->type == 'country' ? auth()->user()->id : auth()->user()->parent_id;
