        ...
        if (
            ...
            DB::statement("
                ...
                SELECT 
                    ...
                    -- الحقول من extra (JSON)
                    JSON_UNQUOTE(JSON_EXTRACT(uhr.extra, '$.reward')) AS reward,
                    JSON_UNQUOTE(JSON_EXTRACT(uhr.extra, '$.type'))   AS reward_type,
                    JSON_UNQUOTE(JSON_EXTRACT(uhr.extra, '$.expire')) AS reward_expire,
