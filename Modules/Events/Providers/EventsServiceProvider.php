...
use Modules\Events\Console\ChargeKingWinnerCommand;
...
class EventsServiceProvider extends ServiceProvider
{
    ...
    protected function registerCommands(): void
    {
        $this->commands([
                            ...
                            PKEventWinnerCommand::class, ChargeKingWinnerCommand::class
                        ]);
    }
    ...
    public function registerViews(): void
    {
        ...
        $componentNamespace =
            str_replace('/', '\\', config('modules.namespace') . '\\' . $this->moduleName . '\\' . config('modules.paths.generator.component-class.path'));
