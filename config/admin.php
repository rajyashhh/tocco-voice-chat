...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Optional list of IPs allowed to reach admin routes. Leave empty to allow
    | all IPs. Enforced by the 'admin.access' middleware. Set via the
    | ADMIN_ALLOWED_IPS env var as a comma-separated list.
    |
    */
...
//                'model'  => Encore\Admin\Auth\Database\Administrator::class,
    ...
    */
    ...
    |
    */
    'default_avatar' => '/vendor/laravel-admin/AdminLTE/dist/img/default-avatar.svg',
