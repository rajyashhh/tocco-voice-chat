...
return [
    ...
    // App-level gzip fallback (CompressResponse middleware). Keep OFF when the
    // edge (nginx) already compresses, so Octane does not double-work.
    'http_gzip' => env('HTTP_GZIP', false),

    // fairbase
    'fileName' => env('FILE_NAME', 'firebase_credentials.json'),
    'projectName' => env('FIREBASE_PROJECT_NAME', ''),
    'senderId' => env('SENDER_ID', ''),
    'utd_secret_key' => env('UTD_SECRET_KEY', ''),
    'utd_client_id' => env('UTD_CLIENT_ID', ''),
    ...
    */
    ...
    'app_origin_name' => env('APP_ORIGIN_NAME', ''),
