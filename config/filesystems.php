...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'public' => [
            'driver' => env('MEDIA_STORAGE_DRIVER', 'gcs'),
...
//            'root' => storage_path('app/public'),
            ...
            // White-label: credentials are injected at runtime from DB settings
            // (see AppServiceProvider::setupStorageCredentials). env is the
            // fallback; no hardcoded service-account.json / placeholder ids.
